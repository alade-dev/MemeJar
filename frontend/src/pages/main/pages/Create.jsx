...
const Create = () => {
  return (
    <div>
      ...
      <form action="" className='text-center bg-slate-50 w-3/4 p-7 rounded-xl mx-auto'>
        <div className='text-xl text-black'>
          <input type="file" name='upload' src="" alt="" />
        </div>

        <div className='text-xl flex-1 mx-auto my-3 -ml-2  text-black'>
          <textarea name="" id="" cols="40" rows="5"  placeholder='Description' className=' bg-[#a8b8e4] w-[380px]   placeholder:text-white p-3 text-white-200 outline-none border-none rounded-xl '></textarea>
        </div>
